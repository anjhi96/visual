...
namespace zakat
{
    public partial class Form8 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // tambah data ke database tabel data_infaq
                conn.Open();
                string query = "INSERT INTO data_infaq(id_transaksi,nama,jumlah) values( '" + acak + "' , '" + nama + "','" + jumlah + "' )";
